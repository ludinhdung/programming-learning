...
// node_modules/@mantine/core/esm/components/Floating/FloatingArrow/FloatingArrow.mjs
var FloatingArrow = (0, import_react132.forwardRef)(
  ({
    position,
    arrowSize,
    arrowOffset,
...
function FocusTrap({
  ...
  return (0, import_react139.cloneElement)(children, { [refProp]: ref });
}
...
function useFloatingAutoUpdate({
  ...
  const [delayedUpdate, setDelayedUpdate] = (0, import_react143.useState)(0);
...
function usePopover(options) {
  ...
  const previouslyOpened = (0, import_react145.useRef)(_opened);
  const onClose = () => {
    if (_opened) {
      setOpened(false);
    }
...
function Popover(_props) {
  ...
  const arrowRef = (0, import_react147.useRef)(null);
  const [targetNode, setTargetNode] = (0, import_react147.useState)(null);
  const [dropdownNode, setDropdownNode] = (0, import_react147.useState)(null);
  const { dir } = useDirection();
  const uid = useId(id);
  ...
  const reference = (0, import_react147.useCallback)(
    (node) => {
      setTargetNode(node);
  ...
  const floating = (0, import_react147.useCallback)(
    (node) => {
  ...
  const onExited = (0, import_react147.useCallback)(() => {
    var _a2;
  ...
  const onEntered = (0, import_react147.useCallback)(() => {
    var _a2;
...
// node_modules/@mantine/core/esm/components/Loader/loaders/Bars.mjs
var Bars = (0, import_react149.forwardRef)(({ className, ...others }, ref) => (0, import_jsx_runtime66.jsxs)(Box, { component: "span", className: clsx_default(classes7.barsLoader, className), ...others, ref, children: [
...
var Dots = (0, import_react150.forwardRef)(({ className, ...others }, ref) => (0, import_jsx_runtime67.jsxs)(Box, { component: "span", className: clsx_default(classes7.dotsLoader, className), ...others, ref, children: [
...
var Oval = (0, import_react151.forwardRef)(({ className, ...others }, ref) => (0, import_jsx_runtime68.jsx)(Box, { component: "span", className: clsx_default(classes7.ovalLoader, className), ...others, ref }));
...
var InputWrapper = factory((_props, ref) => {
  ...
  const _input = (0, import_jsx_runtime92.jsx)(import_react179.Fragment, { children: inputContainer(children) }, "input");
...
var AngleSlider = factory((_props, ref) => {
  ...
  const marksItems = marks == null ? void 0 : marks.map((mark, index3) => (0, import_react197.createElement)(
    "div",
    {
...
function useResizing({ transitionDuration, disabled }) {
  const [resizing, setResizing] = (0, import_react213.useState)(true);
  const resizingTimeout = (0, import_react213.useRef)(-1);
  const disabledTimeout = (0, import_react213.useRef)(-1);
...
var ComboboxClearButton = (0, import_react218.forwardRef)(
...
function useComboboxTargetProps({
  ...
  const ctx = useComboboxContext();
  const [selectedOptionId, setSelectedOptionId] = (0, import_react222.useState)(null);
  const handleKeyDown = (event) => {
    onKeyDown == null ? void 0 : onKeyDown(event);
    if (ctx.readOnly) {
      return;
...
var ComboboxEventsTarget = factory((props, ref) => {
  ...
  return (0, import_react223.cloneElement)(children, {
    ...targetProps,
    ...others,
...
var ComboboxOption = factory((_props, ref) => {
  ...
  const ctx = useComboboxContext();
  const uuid = (0, import_react227.useId)();
  const _id = id || uuid;
...
var ComboboxTarget = factory((props, ref) => {
  ...
  const clonedElement = (0, import_react230.cloneElement)(children, {
    ...targetProps,
    ...others
  });
...
function useCombobox({
  ...
  const listId = (0, import_react231.useRef)(null);
  const selectedOptionIndex = (0, import_react231.useRef)(-1);
  const searchRef = (0, import_react231.useRef)(null);
  const targetRef = (0, import_react231.useRef)(null);
  const focusSearchTimeout = (0, import_react231.useRef)(-1);
  const focusTargetTimeout = (0, import_react231.useRef)(-1);
  const selectedIndexUpdateTimeout = (0, import_react231.useRef)(-1);
  const openDropdown = (0, import_react231.useCallback)(
    (eventSource = "unknown") => {
      if (!dropdownOpened) {
  ...
  const closeDropdown = (0, import_react231.useCallback)(
    (eventSource = "unknown") => {
      if (dropdownOpened) {
  ...
  const toggleDropdown = (0, import_react231.useCallback)(
    (eventSource = "unknown") => {
      if (dropdownOpened) {
  ...
  const clearSelectedItem = (0, import_react231.useCallback)(() => {
  ...
  const selectOption = (0, import_react231.useCallback)(
    (index3) => {
  ...
  const selectActiveOption = (0, import_react231.useCallback)(() => {
  ...
  const selectNextOption = (0, import_react231.useCallback)(
    () => selectOption(
      getNextIndex2(
  ...
  const selectPreviousOption = (0, import_react231.useCallback)(
    () => selectOption(
      getPreviousIndex2(
        selectedOptionIndex.current,
        document.querySelectorAll(`#${listId.current} [data-combobox-option]`),
  ...
  const selectFirstOption = (0, import_react231.useCallback)(
    () => selectOption(
      getFirstIndex(
        document.querySelectorAll(`#${listId.current} [data-combobox-option]`)
      )
  ...
  const updateSelectedOptionIndex = (0, import_react231.useCallback)(
  ...
  const resetSelectedOption = (0, import_react231.useCallback)(() => {
    selectedOptionIndex.current = -1;
    clearSelectedItem();
  }, [clearSelectedItem]);
  const clickSelectedOption = (0, import_react231.useCallback)(() => {
    const items = document.querySelectorAll(
      `#${listId.current} [data-combobox-option]`
    );
  ...
  const setListId = (0, import_react231.useCallback)((id) => {
    listId.current = id;
  }, []);
  const focusSearchInput = (0, import_react231.useCallback)(() => {
    focusSearchTimeout.current = window.setTimeout(() => searchRef.current.focus(), 0);
  }, []);
  const focusTarget = (0, import_react231.useCallback)(() => {
    focusTargetTimeout.current = window.setTimeout(() => targetRef.current.focus(), 0);
  }, []);
  const getSelectedOptionIndex = (0, import_react231.useCallback)(() => selectedOptionIndex.current, []);
...
var InlineInput = (0, import_react233.forwardRef)(
  ({
    __staticSelector,
    __stylesApiProps,
    className,
...
var CheckboxGroupContext = (0, import_react234.createContext)(null);
var CheckboxGroupProvider = CheckboxGroupContext.Provider;
var useCheckboxGroupContext = () => (0, import_react234.useContext)(CheckboxGroupContext);
...
var AvatarGroupContext = (0, import_react243.createContext)(null);
var AvatarGroupProvider = AvatarGroupContext.Provider;
function useAvatarGroupContext() {
  const ctx = (0, import_react243.useContext)(AvatarGroupContext);
...
var Avatar = polymorphicFactory((_props, ref) => {
  ...
  const [error, setError] = (0, import_react245.useState)(!src);
  const getStyles2 = useStyles({
    name: "Avatar",
    props,
    classes: classes28,
  ...
  (0, import_react245.useEffect)(() => setError(!src), [src]);
...
var Breadcrumbs = factory((_props, ref) => {
  ...
  const items = import_react249.Children.toArray(children).reduce((acc, child, index3, array) => {
    var _a;
    const item = isElement(child) ? (0, import_react249.cloneElement)(child, {
      ...getStyles2("breadcrumb", { className: (_a = child.props) == null ? void 0 : _a.className }),
      key: index3
    }) : (0, import_react249.createElement)("div", { ...getStyles2("breadcrumb"), key: index3 }, child);
    acc.push(item);
    if (index3 !== array.length - 1) {
      acc.push(
        (0, import_react249.createElement)(Box, { ...getStyles2("separator"), key: `separator-${index3}` }, separator)
      );
    }
    return acc;
  }, []);
...
var Card = polymorphicFactory((_props, ref) => {
  ...
  const _children = import_react256.Children.toArray(children);
  const content = _children.map((child, index3) => {
    if (typeof child === "object" && child && "type" in child && child.type === CardSection) {
      return (0, import_react256.cloneElement)(child, {
...
var Thumb2 = (0, import_react264.forwardRef)(({ position, ...others }, ref) => (0, import_jsx_runtime175.jsx)(
  Box,
  {
    ref,
    __vars: {
...
var ColorSlider = factory((_props, ref) => {
  ...
  const theme = useMantineTheme();
  const [position, setPosition] = (0, import_react265.useState)({ y: 0, x: value / maxValue });
  ...
  const layers = overlays.map((overlay, index3) => (0, import_react265.createElement)("div", { ...getStyles2("sliderOverlay"), style: overlay, key: index3 }));
...
// node_modules/@mantine/core/esm/components/ColorPicker/AlphaSlider/AlphaSlider.mjs
var defaultProps81 = {};
var AlphaSlider = (0, import_react266.forwardRef)((props, ref) => {
...
var HueSlider = (0, import_react267.forwardRef)((props, ref) => {
...
function Saturation({
  ...
  const [position, setPosition] = (0, import_react268.useState)({ x: value.s / 100, y: 1 - value.v / 100 });
...
var Swatches = (0, import_react269.forwardRef)(
  ({
    className,
    datatype,
    setValue,
    ...
    const colors = data.map((color, index3) => (0, import_react269.createElement)(
      ColorSwatch,
      {
...
var ColorPicker = factory((_props, ref) => {
  ...
  const formatRef = (0, import_react270.useRef)(format2);
  const valueRef = (0, import_react270.useRef)("");
  const scrubTimeoutRef = (0, import_react270.useRef)(-1);
  const isScrubbingRef = (0, import_react270.useRef)(false);
  ...
  const [parsed, setParsed] = (0, import_react270.useState)(parseColor(_value));
  const startScrubbing = () => {
...
var ColorInput = factory((_props, ref) => {
  ...
  const [dropdownOpened, setDropdownOpened] = (0, import_react271.useState)(false);
  const [lastValidValue, setLastValidValue] = (0, import_react271.useState)("");
  const [_value, setValue] = useUncontrolled({
    value,
    defaultValue,
    finalValue: "",
...
function useVirtualizedCombobox({
  ...
  const listId = (0, import_react272.useRef)(null);
  const searchRef = (0, import_react272.useRef)(null);
  const targetRef = (0, import_react272.useRef)(null);
  const focusSearchTimeout = (0, import_react272.useRef)(-1);
  const focusTargetTimeout = (0, import_react272.useRef)(-1);
  const openDropdown = () => {
    if (!dropdownOpened) {
      setDropdownOpened(true);
  ...
  const getSelectedOptionIndex = (0, import_react272.useCallback)(() => selectedOptionIndex, []);
  return {
    dropdownOpened,
    openDropdown,
    closeDropdown,
...
function DrawerStack({ children }) {
  const [stack, setStack] = (0, import_react284.useState)([]);
  const [maxZIndex, setMaxZIndex] = (0, import_react284.useState)(getDefaultZIndex("modal"));
...
var HoverCardTarget = (0, import_react301.forwardRef)((props, ref) => {
  ...
  return (0, import_jsx_runtime211.jsx)(Popover.Target, { refProp, ref, ...others, children: (0, import_react301.cloneElement)(
    children,
...
var Image = polymorphicFactory((_props, ref) => {
  ...
  const [error, setError] = (0, import_react304.useState)(!src);
...
var index = import_react307.useLayoutEffect;
