...
var V4 = K(function(t11, o17) {
  let a20 = (0, import_react49.useId)(), { id: l14 = `headlessui-dialog-${a20}`, open: i15, onClose: p6, initialFocus: d13, role: s13 = "dialog", autoFocus: f22 = true, __demoMode: u17 = false, unmount: P7 = false, ...h7 } = t11, R9 = (0, import_react90.useRef)(false);
  s13 = function() {
...
var we = "div";
function Be(e8, t11) {
  let o17 = (0, import_react49.useId)(), { id: a20 = `headlessui-dialog-panel-${o17}`, transition: l14 = false, ...i15 } = e8, [{ dialogState: p6, unmount: d13 }, s13] = O6("Dialog.Panel"), f22 = y(t11, s13.panelRef), u17 = (0, import_react90.useMemo)(() => ({ open: p6 === 0 }), [p6]), P7 = o4((S7) => {
    S7.stopPropagation();
...
var Pe2 = "button";
function Ee(e8, t11) {
  let l14 = (0, import_react49.useId)(), { id: p6 = `headlessui-disclosure-button-${l14}`, disabled: i15 = false, autoFocus: c15 = false, ...n13 } = e8, [o17, r17] = M8("Disclosure.Button"), m10 = fe3(), s13 = m10 === null ? false : m10 === o17.panelId, E12 = (0, import_react92.useRef)(null), f22 = y(E12, t11, o4((u17) => {
...
var ge2 = O.RenderStrategy | O.Static;
function Ae4(e8, t11) {
  let l14 = (0, import_react49.useId)(), { id: p6 = `headlessui-disclosure-panel-${l14}`, transition: i15 = false, ...c15 } = e8, [n13, o17] = M8("Disclosure.Panel"), { close: r17 } = J4("Disclosure.Panel"), [m10, s13] = (0, import_react92.useState)(null), E12 = y(t11, o4((b9) => {
...
function c13(d13, l14) {
  let t11 = `headlessui-control-${(0, import_react49.useId)()}`, [s13, p6] = K2(), [n13, a20] = w3(), m10 = a3(), { disabled: e8 = m10 || false, ...i15 } = d13, o17 = (0, import_react93.useMemo)(() => ({ disabled: e8 }), [e8]), F6 = { ref: l14, disabled: e8 || void 0, "aria-disabled": e8 || void 0 }, T10 = L();
...
function Ft2(e8, i15) {
  var $3, q4;
  let o17 = (0, import_react49.useId)(), { id: r17 = `headlessui-listbox-options-${o17}`, anchor: a20, portal: m10 = false, modal: x10 = true, transition: d13 = false, ...p6 } = e8, n13 = xe(a20), [u17, P7] = (0, import_react100.useState)(null);
  n13 && (m10 = true);
...
function ut(e8, n13) {
  let r17 = (0, import_react49.useId)(), { id: l14 = `headlessui-menu-item-${r17}`, disabled: o17 = false, ...u17 } = e8, [p6, s13] = w9("Menu.Item"), m10 = p6.activeItemIndex !== null ? p6.items[p6.activeItemIndex].id === l14 : false, a20 = (0, import_react101.useRef)(null), t11 = y(n13, a20);
  n(() => {
...
function ft2(o17, a20) {
  let f22 = (0, import_react49.useId)(), { id: C9 = `headlessui-popover-button-${f22}`, disabled: T10 = false, autoFocus: S7 = false, ...p6 } = o17, [l14, c15] = se3("Popover.Button"), { isPortalled: d13 } = be4("Popover.Button"), r17 = (0, import_react102.useRef)(null), s13 = `headlessui-focus-sentinel-${(0, import_react49.useId)()}`, R9 = Me3(), m10 = R9 == null ? void 0 : R9.closeOthers, P7 = st2() !== null;
...
function Oe2(o17, a20) {
  let f22 = (0, import_react49.useId)(), { id: C9 = `headlessui-popover-backdrop-${f22}`, transition: T10 = false, ...S7 } = o17, [{ popoverState: p6 }, l14] = se3("Popover.Backdrop"), [c15, d13] = (0, import_react102.useState)(null), r17 = y(a20, d13), s13 = u13(), [R9, m10] = x3(T10, c15, s13 !== null ? (s13 & i11.Open) === i11.Open : p6 === 0), h7 = o4((g6) => {
...
function yt3(o17, a20) {
  let f22 = (0, import_react49.useId)(), { id: C9 = `headlessui-popover-panel-${f22}`, focus: T10 = false, anchor: S7, portal: p6 = false, modal: l14 = false, transition: c15 = false, ...d13 } = o17, [r17, s13] = se3("Popover.Panel"), { close: R9, isPortalled: m10 } = be4("Popover.Panel"), h7 = `headlessui-focus-sentinel-before-${f22}`, P7 = `headlessui-focus-sentinel-after-${f22}`, n13 = (0, import_react102.useRef)(null), v4 = xe(S7), [g6, _8] = Re(v4), L6 = be();
  v4 && (p6 = true);
...
function He3(o17, t11) {
  var y9;
  let e8 = X3("RadioGroup.Option"), a20 = q3("RadioGroup.Option"), g6 = (0, import_react49.useId)(), { id: R9 = `headlessui-radiogroup-option-${g6}`, value: O7, disabled: n13 = e8.disabled || false, autoFocus: f22 = false, ...c15 } = o17, p6 = (0, import_react103.useRef)(null), I6 = y(p6, t11), [m10, T10] = K2(), [P7, C9] = w3(), i15 = s3({ value: O7, disabled: n13 });
...
function Ne3(o17, t11) {
  var y9;
  let e8 = X3("Radio"), a20 = q3("Radio"), g6 = (0, import_react49.useId)(), R9 = u5(), O7 = a3(), { id: n13 = R9 || `headlessui-radio-${g6}`, value: f22, disabled: c15 = e8.disabled || O7 || false, autoFocus: p6 = false, ...I6 } = o17, m10 = (0, import_react103.useRef)(null), T10 = y(m10, t11), P7 = I(), C9 = U2(), i15 = s3({ value: f22, disabled: c15 });
...
function xe3(n13, o17) {
  var L6;
  let s13 = (0, import_react49.useId)(), h7 = u5(), b9 = a3(), { id: T10 = h7 || `headlessui-switch-${s13}`, disabled: t11 = b9 || false, checked: p6, defaultChecked: y9, onChange: S7, name: c15, value: u17, form: d13, autoFocus: m10 = false, ...F6 } = n13, _8 = (0, import_react105.useContext)(E10), [H13, k5] = (0, import_react105.useState)(null), M9 = (0, import_react105.useRef)(null), U8 = y(M9, o17, _8 === null ? null : _8.setSwitch, k5), l14 = l2(y9), [a20, r17] = T(p6, S7, l14 != null ? l14 : false), I6 = p(), [P7, D6] = (0, import_react105.useState)(false), g6 = o4(() => {
...
function Ge4(e8, r17) {
  var ee7, te6;
  let t11 = (0, import_react49.useId)(), { id: l14 = `headlessui-tabs-tab-${t11}`, disabled: a20 = false, autoFocus: n13 = false, ...s13 } = e8, { orientation: g6, activation: b9, selectedIndex: f22, tabs: d13, panels: u17 } = C8("Tab"), T10 = Y3("Tab"), p6 = C8("Tab"), [c15, h7] = (0, import_react107.useState)(null), m10 = (0, import_react107.useRef)(null), M9 = y(m10, r17, h7);
...
function Ne4(e8, r17) {
  var A7, E12, _8, D6;
  let t11 = (0, import_react49.useId)(), { id: l14 = `headlessui-tabs-panel-${t11}`, tabIndex: a20 = 0, ...n13 } = e8, { selectedIndex: s13, tabs: g6, panels: b9 } = C8("Tab.Panel"), f22 = Y3("Tab.Panel"), d13 = (0, import_react107.useRef)(null), u17 = y(d13, r17);
