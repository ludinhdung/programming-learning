...
void main() {
    ...
    float angle = radians(90.0);  // Tăng từ 45 lên 90 độ theo chiều kim đồng hồ
    float cosA = cos(angle);
    float sinA = sin(angle);
    
    // Đầu tiên swap x và y như code cũ
    vec2 st = vec2(vUvs.y, vUvs.x);
...
class InfiniteGridMenu {
  ...
  private TARGET_FRAME_DURATION = 1000 / 144; // 60 fps
