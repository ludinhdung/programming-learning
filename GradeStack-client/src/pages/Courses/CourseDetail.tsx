                            ...
                            <div className="flex flex-col-reverse">
                                <div className="p-8">
                                    ...
                                    <div className="flex space-x-4">
                                        {courseData.instructor.socials.map((social: string, index: number) => (
                                            <a
                                                key={index}
                                                href={social}
                                                target="_blank"
                    ...
                    <div className="md:col-span-2">
                        ...
                        <div className="mb-4 flex flex-wrap items-center justify-start space-x-6 text-xs text-white font-medium">
                            <span className="flex items-center">
                                ...
                                {courseData.modules.reduce((total: number, module) => total + module.lessons.length, 0)} lessons
                            </span>
                            <span className="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" className="mr-2 h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
                                ...
                                <div key={module.id}>
                                    <div className="flex flex-row justify-between mb-4 border border-[#14202e] p-4">
                                        <h2 className="text-xl font-bold text-white">
                                            <span className="text-[#3b82f6] mr-2">//</span> {module.title}
                                        </h2>
                                        <button
                                    ...
                                    <div className={`transition-all duration-500 ease-in-out overflow-hidden ${expandedSections.includes(module.id) ? 'max-h-[2000px] opacity-100' : 'max-h-0 opacity-0'}`}>
                                        {module.lessons.map((lesson) => (
                                            ...
                                            >
                                                <div className="flex items-center">
                                                    ...
                                                    <div className="flex-1">
                                                        <div className="flex items-center">
                                                            <h3 className="text-xl mb-2 font-medium text-white">{lesson.title}</h3>
                                                        </div>
