                                ...
                                <div className="p-8">
                                    ...
                                    <p className="text-white text-sm font-medium leading-relaxed mb-6">
                                        {courseData.instructor.bio ||
                                            `Hi, ${courseData.instructor.user.firstName} ${courseData.instructor.user.lastName}. I'm the creator of GradeStacks and spend most of my days building the site and thinking of new ways to teach confusing concepts. I live in Orlando, Florida with my wife and two kids.`}
                                    </p>
