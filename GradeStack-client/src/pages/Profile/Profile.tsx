...
const Profile: FC = () => {
  ...
  const [errorCertificates, setErrorCertificates] = useState<string | null>(
    null
  );
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-7xl mx-auto">
          <Layout className="bg-transparent">
            <Sider
              width={250}
              className="bg-[#0a1321] p-6 border-r border-[#1e2736]"
            >
              <Menu
                mode="inline"
                    ...
                    {!loadingEnrolled && !errorEnrolled && (
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {enrolledCourses.length === 0 ? (
                          <p className="text-[#94a3b8] text-center py-4 col-span-full">
                          ...
                          enrolledCourses.map((enrollment) => (
                            <div
                              ...
                              className="bg-[#13151f] rounded-lg hover:bg-[#1a1f2e] transition-colors overflow-hidden shadow-md"
                            >
                              <div className="flex gap-4 p-4">
                                ...
                                <div className="flex-1">
                                  {" "}
                                  <h3 className="text-lg font-semibold text-white hover:text-[#3b82f6] transition-colors">
                                    {enrollment.course.title}
                                  </h3>
                                  <div className="flex items-center text-[#94a3b8] mb-3">
                                    <Avatar
                                      size="small"
                                      className="mr-2 bg-[#3b82f6]"
                                    >
                                      {enrollment.course.instructor.user.firstName.charAt(
                                        0
                                      )}
                                    </Avatar>
                                    <span>
                            ...
                            >
                              <div className="flex gap-4 p-4">
                                ...
                                <div className="flex-1">
                                  ...
                                  <div className="flex items-center text-[#94a3b8] mb-2">
                                    <Avatar
                                      size="small"
                                      className="mr-2 bg-[#f59e0b]"
                                    >
                                      {bookmark.course.instructor.user.firstName.charAt(
                                        0
                                      )}
                                    </Avatar>
                                    <span>
                                      {
                                        bookmark.course.instructor.user
                                          .firstName
                                      }{" "}
                                      {bookmark.course.instructor.user.lastName}
                                    </span>
                                  </div>
                                </div>
                              </div>
                              <div className="bg-[#1e2736] py-2 px-4 flex justify-end">
                                <Button
                                  ...
                                  href={`/courses/${bookmark.course.id}`}
                                >
                                  View Course
                                </Button>
                              </div>
